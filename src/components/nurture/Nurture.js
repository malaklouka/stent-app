...
<div className="container-fluid">
    ...
    <div className="header"><div className="header-body"><div className="row align-items-end">
        <div className="col"><h6 className="header-pretitle">Campaigns</h6>
        <h1 className="header-title">Nurture campaigns</h1></div>
        <div className="col-auto">
            <button type="button" className="btn btn-primary" id="new-campaign-button">Create a nurture campaign</button></div></div></div></div></div></div>
            <div id="campaigns-filter-wrapper" className="d-flex align-items-center">
                    ...
                    <select className="form-control filter-table filter-table-select" id="filter-table-program">
                        ...
                        <div className="form-group mr-3">
                            <select className="form-control filter-table filter-table-select" id="filter-table-name">
                                ...
                                <option value="test">test</option></select></div>
                                <div className="form-group mr-3">
                                    <select className="form-control filter-table filter-table-select" id="filter-table-sender">
                                        <option value="">Ambassador</option>
                                        <option value="ACoAAA-q4hMBLwO_XntcZyW5GXN9eSG5X6YGPkA">Philip Cooper</option></select></div>
                                            ...
                                            <div className="form-group mr-3">
                                                <select className="form-control filter-table filter-table-select active" id="filter-table-status">
                                                    ...
                                                    <option value="stop">Status: stopped</option></select></div><div className="form-group">
                                                        ...
                                                        <div className="form-group ml-3 pl-4 d-flex" style={{borderLeft: "1px solid #ddd2ec"}}>
                                                            <div className="custom-control custom-switch" style={{transform: "scale(0.75)", transformOigin: "left"}}>
