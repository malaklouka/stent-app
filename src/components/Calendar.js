      ...
      <div style={{ marginLeft: "300px" }}>
        ...
        >
          <div className="col h-100" id="planification">
            <div
              className="stent-calendar fc fc-ltr fc-unthemed"
              id="planification-calendar"
            >
              <div className="fc-toolbar fc-header-toolbar">
                ...
                <div className="fc-right">
                  <div className="fc-button-group">
                    <button
                      type="button"
                      className="fc-listMonth-button fc-button fc-button-primary"
                    >
                      list
                    </button>
                    <button
                      type="button"
                      className="fc-dayGridWeek-button fc-button fc-button-primary"
                    >
                      week
                    </button>
                    <button
                      ...
                      <tr>
                        <td className="fc-widget-content">
                          <div
                            ...
                            style={{ overflow: "hidden", height: "738.344px" }}
                          >
                                  ...
                                  <table className="">
                                    <tbody>
                                      <tr>
                                        ...
                                        ></td>
                                        <td
                                          className="fc-day fc-widget-content fc-sat fc-today "
                                  ...
                                  <table>
                                    <thead>
                                      <tr>
                                        ...
                                        <td
                                          className="fc-day-top fc-sat fc-today "
                                          data-date="2022-05-07"
                                        >
                                          <span className="fc-day-number">
                                            7
                                ...
                                <div className="fc-content-skeleton">
                                  <table>
                                    <thead>
                                      <tr>
                                        <td
                                          className="fc-day-top fc-sun fc-future"
                                          data-date="2022-05-08"
                                        >
                                          <span className="fc-day-number">
                                            8
                                        ...
                                        <td
                                          className="fc-day-top fc-mon fc-future"
                                          data-date="2022-05-09"
                                        >
                                          <span className="fc-day-number">
                                            9
                                        ...
                                        <td
                                          className="fc-day-top fc-tue fc-future"
                                          data-date="2022-05-10"
                                        >
                                          <span className="fc-day-number">
                                            10
                                        ...
                                        <td
                                          className="fc-day-top fc-wed fc-future"
                                          data-date="2022-05-11"
                                        >
                                          <span className="fc-day-number">
                                            11
                                        ...
                                        <td
                                          className="fc-day-top fc-thu fc-future"
                                          data-date="2022-05-12"
                                        >
                                          <span className="fc-day-number">
                                            12
                                        ...
                                        <td
                                          className="fc-day-top fc-fri fc-future"
                                          data-date="2022-05-13"
                                        >
                                          <span className="fc-day-number">
                                            13
                                        ...
                                        <td
                                          className="fc-day-top fc-sat fc-future"
                                          data-date="2022-05-14"
                                        >
                                          <span className="fc-day-number">
                                            14
                                  ...
                                  <table>
                                    <thead>
                                      <tr>
                                        ...
                                        <td
                                          className="fc-day-top fc-wed fc-other-month fc-future"
                                          data-date="2022-06-01"
                                        >
                                          <span className="fc-day-number">
                                            1
                                        ...
                                        <td
                                          className="fc-day-top fc-thu fc-other-month fc-future"
                                          data-date="2022-06-02"
                                        >
                                          <span className="fc-day-number">
                                            2
                                        ...
                                        <td
                                          className="fc-day-top fc-fri fc-other-month fc-future"
                                          data-date="2022-06-03"
                                        >
                                          <span className="fc-day-number">
                                            3
                                        ...
                                        <td
                                          className="fc-day-top fc-sat fc-other-month fc-future"
                                          data-date="2022-06-04"
                                        >
                                          <span className="fc-day-number">
                                            4
