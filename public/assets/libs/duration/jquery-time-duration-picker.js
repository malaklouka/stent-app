  ...
  $.widget("custom.timeDurationPicker", {
    ...
    _create: function () {
      ...
      this._content.button.addClass(
        "ui-button ui-widget ui-state-default ui-corner-all btn-primary btn-sm"
      );
    ...
    _createNumberInput: function (value, min, max) {
      ...
      var input = $("<input class='form-control' style='height: auto; padding: 0.25em 0.25em 0.25em 1em;' type='number' />");
